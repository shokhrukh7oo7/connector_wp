      ...
      <div class="it-service-wrapper">
        ...
        <div class="banner-content-wrapper">
          <div class="banner-wrapper">
            <img src="<?= get_template_directory_uri() ?> /assets/images/it-system-design/banner.png" alt="image" />
          </div>
          ...
          <div class="it-system-banner-description">
            ...
            <div class="right-wrapper">
              ...
              <div class="icon-wrapper">
                <img src="<?= get_template_directory_uri() ?> /assets/images/it-system-design/icon.svg" alt="image" />
              </div>
            </div>
          </div>
